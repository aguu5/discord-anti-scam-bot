...
async def main():
    ...
    # Test UndoActionView with quarantine_role_id
    ...
    # Test UndoActionView with timeout
    ...
    assert len(channel.sent_messages) == 2, "Should send restored message"
    assert "Timeout scam" in channel.sent_messages[1]
